...
from yelp_GPT import BucketSampler, BucketingDataLoader, TokenDataset
...
class _DATA():
    ...
    def f_load_data_yelp_GPT(self, tokenizer, args):
        train_data_file = args.data_dir+"/train.pickle"
        valid_data_file = args.data_dir+"/valid.pickle"
        test_data_file = args.data_dir+"/test.pickle"

        train_data_loader = BucketingDataLoader(train_data_file, args.batch_size, args.max_seq_length, [tokenizer], args, bucket=100, shuffle=False)
        test_data_loader = BucketingDataLoader(test_data_file, args.batch_size, args.max_seq_length, [tokenizer], args, bucket=100, shuffle=False)
        ...
        print("user num: ", len(global_user2iid))
        print("item num: ", len(global_item2iid))

        return train_data_loader, test_data_loader, vocab_obj
