...
class INFER(object):
    ...
    def f_init_infer(self, network, model_file=None, reload_model=False):
        ...
        #         if name == "m_decoder_rnn.weight_hh_l0":
        #             print(name, "\t", param.data)

        #         if name == "m_decoder_rnn.bias_hh_l0":
        #             print(name, "\t", param.data)
    ...
    def f_inference(self, eval_data):
        ...
        for input_batch, target_batch, length_batch in eval_data:
            ...
            logp, _, _, _, last_de_hidden, encoder_outputs = self.m_network(input_batch, length_batch)
    ...
    def f_decode_text(self, z, encoder_outputs, max_seq_len, n=4):
        ...
        while(t < max_seq_len and len(running_seqs)>0):
            ...
            # random_output = torch.randn(output.size()).to(self.m_device)
