...
class _TRAINER(object):
    ...
    def f_train_epoch(self, train_data, network, optimizer, logger_obj):
        ...
        network.train()
        for attr_batch, attr_ind_batch, attr_tf_batch, attr_feat_batch, attr_length_batch, attr_length_user_batch, attr_length_item_batch, user_batch, item_batch, pos_target_batch, pos_length_batch, neg_target_batch, neg_length_batch in train_data:
            ...
            logits, mask, targets = network(attr_gpu, attr_ind_gpu, attr_tf_gpu, attr_feat_gpu, attr_length_gpu, attr_length_user_gpu, attr_length_item_gpu, user_gpu, item_gpu, pos_target_gpu, pos_length_gpu, neg_target_gpu, neg_length_gpu)
    ...
    def f_eval_epoch(self, eval_data, network, optimizer, logger_obj):
        ...
        with torch.no_grad():
            for attr_batch, attr_ind_batch, attr_tf_batch, attr_feat_batch, attr_length_batch, attr_length_user_batch, attr_length_item_batch, user_batch, item_batch, target_batch, target_mask_batch in eval_data:			
                ...
                logits = network.f_eval_forward(attr_gpu, attr_ind_gpu, attr_tf_gpu, attr_feat_gpu, attr_length_gpu, attr_length_user_gpu, attr_length_item_gpu, user_gpu, item_gpu)
