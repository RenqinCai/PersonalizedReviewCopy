...
class _YELP(Dataset):
    ...
    def __getitem__(self, idx):
        ...
        return input_i, input_length_i, user_i, item_i, target_i, target_length_i, self.m_pad_id
    ...
    def collate(batch):
        ...
        return input_iter_tensor, input_length_iter_tensor, user_iter_tensor, item_iter_tensor, target_iter_tensor, target_length_iter_tensor, random_flag
