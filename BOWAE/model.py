...
class REVIEWDI(nn.Module):
    ...
    def forward(self, input_sequence, length):
        ...
        init_de_hidden = self.m_hidden2hidden(encoder_last_hidden)
        ...
        logits = self.m_output2vocab(init_de_hidden.view(-1, init_de_hidden.size(1)))
    
        return logits, _, _, _, init_de_hidden
