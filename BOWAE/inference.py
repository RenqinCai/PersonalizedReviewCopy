...
class INFER(object):
    def __init__(self, vocab_obj, args, device):
        ...
        self.m_vocab_size = vocab_obj.m_vocab_size
    ...
    def f_decode_BOW(self, z, length_batch, n=4):
        ...
        word_logits = self.m_network.m_output2vocab(init_hidden)
        ...
        for sample_index in range(batch_size):
            ...
            _, sampled_words_index = torch.topk(word_probs[sample_index], length_index)
