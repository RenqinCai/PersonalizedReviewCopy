...
class INFER(object):
    ...
    def f_decode_text(self, z, s, l, max_seq_len, n=4):
        ...
        attn_score_step_i = torch.zeros(batch_size, 3).fill_(1.0/3).to(self.m_device)
    ...
    def _save_sample(self, save_to, attn_score, attn_score_step_i, sample, running_seqs, t):
        ...
        running_flags = attn_score[running_seqs]
        running_flags[:, t, :] = attn_score_step_i.squeeze().data
        attn_score[running_seqs] = running_flags
