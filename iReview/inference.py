    ...
    def f_inference(self, train_data, eval_data):
        ...
        with torch.no_grad():
            for input_batch, length_batch, user_batch, item_batch, target_batch, _ in eval_data:
                ...
                logits_gpu, z_mean_gpu, z_logv_gpu, z_gpu, s_mean_gpu, s_logv_gpu, s_gpu, var_hidden_gpu = self.m_network(input_batch_gpu, length_batch_gpu, user_batch_gpu)
