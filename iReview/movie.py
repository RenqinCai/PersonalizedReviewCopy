...
class _MOVIE(Dataset):
    ...
    def __iter__(self):
        ...
        for batch_i in range(self.m_batch_num):
            ...
            yield input_iter_tensor, input_length_iter_tensor, user_iter_tensor, item_iter_tensor, target_iter_tensor, target_length_iter_tensor
...
class _MOVIE_TEST(Dataset):
    ...
    def __iter__(self):
        ...
        for batch_i in range(self.m_batch_num):
            ...
            yield input_iter_tensor, length_iter_tensor, user_iter_tensor, item_iter_tensor, target_iter_tensor, length_iter_tensor