...
class REVIEWDI(nn.Module):
    def __init__(self, vocab_obj, args, device):
        ...
        self.m_decoder_rnn = nn.GRU(self.m_embedding_size+self.m_hidden_size, self.m_hidden_size, num_layers=self.m_num_layers, bidirectional=self.m_bidirectional, batch_first=True)
