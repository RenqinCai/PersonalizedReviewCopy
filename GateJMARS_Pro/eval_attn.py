    ...
    def f_decode_text(self, m, z, s, max_seq_len, n=4):
        ...
        while(t < max_seq_len and len(running_seqs)>0):
            ...
            if len(running_seqs) > 0:
                ...
                general_output_step_i = self.m_network.m_generator.m_output_general_word(output_step_i)
                item_output_step_i = self.m_network.m_generator.m_output_item_word(output_step_i)
                aspect_output_step_i = self.m_network.m_generator.m_output_aspect_word(output_step_i)
                ...
                general_input_de_step_i = self.m_network.m_generator.m_input_general_word(input_de_step_i)
                item_input_de_step_i = self.m_network.m_generator.m_input_item_word(input_de_step_i)
                aspect_input_de_step_i = self.m_network.m_generator.m_input_aspect_word(input_de_step_i)
