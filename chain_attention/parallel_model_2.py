...
#         weighted_attr_item_logits = attr_item_logits*attr_attn_item
#         # weighted_user_attr_item_logits = user_attr_item_logits*attr_item
        
#         weighted_attr_item_mask = attr_item_mask.unsqueeze(-1).expand(weighted_attr_item_logits.size())

#         weighted_attr_item_logits.data.masked_fill_(weighted_attr_item_mask.data, -float('inf'))
#         attr_item_output = torch.max(weighted_attr_item_logits, 1)[0]
...
#         weighted_attr_user_logits = attr_user_logits*attr_attn_user
#         # weighted_item_attr_user_logits = item_attr_user_logits*attr_user

#         weighted_attr_user_mask = attr_user_mask.unsqueeze(-1).expand(weighted_attr_user_logits.size())

#         weighted_attr_user_logits.data.masked_fill_(weighted_attr_user_mask.data, -float('inf'))
#         attr_user_output = torch.max(weighted_attr_user_logits, 1)[0]

#         # user_output = user_embed
#         # item_output = item_embed

#         user_output = user_embed+attr_user_output
#         item_output = item_embed+attr_item_output
...
#         # attr_item_logits = attr_item_logits
#         # user_attr_item_logits = user_attr_item + attr_item_logits

#         ### attr_item_logits: batch_size*attr_len_item
#         # attr_item_logits = attr_item_logits.unsqueeze(-1)
