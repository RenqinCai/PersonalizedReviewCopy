...
class _WINE(Dataset):
    def __init__(self, args, vocab_obj, df, boa_item_dict, boa_user_dict):
        ...
        # for sample_index in range(1000):
            ...
            # exit()
            self.m_neg_target_list.append(neg_target_list)
            self.m_neg_len_list.append(len(neg_target_list))
    ...
    def __getitem__(self, idx):
        ...
        sample_i = {"attr_item": attr_item_i, "attr_tf_item": attr_tf_item_i, "attr_length_item": attr_length_item_i, "item": item_i, "attr_user": attr_user_i, "attr_tf_user": attr_tf_user_i, "attr_length_user": attr_length_user_i, "user": user_i,  "pos_target": pos_target_i, "pos_len": pos_len_i, "neg_target": neg_target_i, "neg_len": neg_len_i, "vocab_size": self.m_vocab_size}
