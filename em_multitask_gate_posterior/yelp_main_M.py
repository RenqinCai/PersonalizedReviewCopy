...
def main(args):
    ...
    if  args.train:
        ...
        trainer.f_train_M(train_data, valid_data, E_network, network, de_optimizer, logger_obj, 0)
...
if __name__ == "__main__":
    ...
    parser.add_argument('-l_eb', '--l_embedding_size', type=int, default=64)
    parser.add_argument('-ed', '--embedding_dropout', type=float, default=0.5)

    parser.add_argument('--local_rank', type=int, help="local rank, necessary for using the torch.distributed.launch utility")

    parser.add_argument('-hs', '--hidden_size', type=int, default=256)
    parser.add_argument('-l_hs', '--l_hidden_size', type=int, default=32)
    ...
    parser.add_argument('--word_type_num', type=int, default=2)
