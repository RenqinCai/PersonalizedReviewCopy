...
def main(args):
    ...
    train_data, valid_data, vocab_obj = data_obj.f_load_data_cloth(args)
    ...
    if args.test:
        ...
        infer = _INFER(vocab_obj, args, device)
...
if __name__ == "__main__":
    ...
    parser.add_argument('-eb', '--embedding_size', type=int, default=512)
