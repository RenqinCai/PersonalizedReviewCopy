...
class _Data():
    ...
    def _load_data_amazon(self, args):
        self.m_data_name = args.data_name
        self.m_vocab_file = self.m_data_name+"_vocab.json"
    ...
    def save_data2file(self, args):
        f = open(args.txt_data_file, 'w')
...
if __name__ == "__main__":
    ...
    parser.add_argument('--txt_data_file', type=str, default="clothing.txt")
