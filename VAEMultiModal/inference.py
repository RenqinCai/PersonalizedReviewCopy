...
class INFER(object):
    ...
    def f_inference(self, eval_data):
        ...
        for input_batch, target_batch, length_batch in eval_data:
            ...
            logp, z_mean_pool, z_logv_pool, last_en_hidden, hidden_pool = self.m_network(input_batch, length_batch)
            ...
            samples, scores = self.f_decode_text(last_en_hidden, hidden_pool, max_seq_len)
