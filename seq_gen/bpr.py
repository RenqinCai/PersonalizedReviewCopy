...
class BPR(nn.Module):
    def __init__(self, vocab_obj, args, device):
        ...
        # self.m_label_transform_1 = nn.Linear(self.m_vocab_size, self.m_vocab_size, bias=False)

        # self.m_label_transform_2 = nn.Linear(self.m_vocab_size, self.m_vocab_size, bias=False)

        # self.m_x_enc = SetTransformer2(self.m_attr_embed_size, num_outputs=1, dim_output=1, dim_hidden=64, num_heads=1)
