...
def main(args):
    ...
    if pretrain_model_file != "":
        ...
        pretrain_model_abs_file = os.path.join(args.model_path, pretrain_model_file)
    ...
    if args.train:
        ...
        trainer.f_train(pretrain_network, train_data, valid_data, network, optimizer, logger_obj)
...
if __name__ == "__main__":
    ...
    parser.add_argument('--model_name', type=str, default="set2set")
