...
class _ATTR_NETWORK(nn.Module):
    ...
    def forward(self, pos_attr_set, pos_attr_lens, neg_attr_set, neg_attr_lens, neg_attr_set_num, user_ids, item_ids):
    ...
    def f_eval_forward(self, pos_attr_set, pos_attr_lens, neg_attr_set, neg_attr_lens, neg_attr_set_num, user_ids, item_ids):
        pos_attr_embed_user = self.m_output_attr_embedding_user(pos_attr_set)
        pos_attr_embed_item = self.m_output_attr_embedding_item(pos_attr_set)
    ...
    def f_greedy_decode(self, user_ids, item_ids, pre_attrs, targets, step_index):
        ...
        if step_index > 0:
            ...
            dup_attr_item = attr_item.repeat(batch_size, 1, 1)
        ...
        # print("target_score", target_score.size())
        ...
        if step_index > 0:
            ...
            # print("target_score[target_mask]", target_score[target_mask].size())
    ...
    def f_get_score(self, batch_size, user, attr, targets, pre_attr):
        ...
        user_score = user_score.reshape(batch_size, -1, 1).squeeze(-1)
