...
class _WINE(Dataset):
    ...
    def __getitem__(self, idx):
        ...
        sample_i = {"user": user_i,  "item": item_i, "pos_target": pos_target_i, "pos_len": pos_len_i, "neg_target": neg_target_i, "neg_len": neg_len_i, "negtarget_num": negtarget_num_i, "max_seq_len": self.m_max_seq_len}
    ...
    def collate(batch):
        ...
        return pos_target_iter_tensor, pos_len_iter_tensor, neg_target_iter_tensor, neg_len_iter_tensor, negtarget_num_iter_tensor, user_iter_tensor, item_iter_tensor
