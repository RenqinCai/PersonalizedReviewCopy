...
# from train_flicker import _TRAINER
...
# from model_flicker import _ATTR_NETWORK
...
def main(args):
    ...
    data_obj = _DATA()
    if "flicker" in args.data_name:
        train_data, valid_data, vocab_obj = data_obj.f_load_data_flicker(args)
    ...
    if "flicker" not in args.data_name:
...
if __name__ == "__main__":
    ...
    parser.add_argument('--attn_linear_size', type=int, default=2048)
