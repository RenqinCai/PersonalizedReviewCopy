...
class _ATTR_NETWORK(nn.Module):
    ...
    def forward(self, attr_item, attr_tf_item, attr_lens_item, item_ids, attr_user, attr_tf_user, attr_lens_user, user_ids):
        ...
        # for i, attr_item_i in enumerate(attr_item):
        #     logits[i, attr_item_i] = logits[i, attr_item_i] + attr_tf_item[i]*(~attr_item_mask[i])
        ...
        # for i, attr_user_i in enumerate(attr_user):
        #     logits[i, attr_user_i] = logits[i, attr_user_i] + attr_tf_user[i]*(~attr_user_mask[i])
